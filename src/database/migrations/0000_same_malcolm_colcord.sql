CREATE TYPE "public"."guest_role" AS ENUM('Stock Manager', 'Store Keeper');--> statement-breakpoint
CREATE TYPE "public"."guest_status" AS ENUM('Active', 'Inactive', 'Expired');--> statement-breakpoint
